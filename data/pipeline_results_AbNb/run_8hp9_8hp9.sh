#!/bin/bash
#SBATCH --job-name=af_8hp9_8hp9
#SBATCH --output=pipeline_results_AbNb/slurm_8hp9_8hp9_%j.log
...
logging.basicConfig(
    ...
    handlers=[
        logging.FileHandler(f"pipeline_results_AbNb/process_8hp9_8hp9.log"),
