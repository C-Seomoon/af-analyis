#!/bin/bash
#SBATCH --job-name=af_7sjn_6x97
#SBATCH --output=pipeline_results_ABAG_decoy/slurm_7sjn_6x97_%j.log
...
def process_query(query_name):
    base_path = "/home/cseomoon/project/ABAG/DB/ABAG_structure/AF3/decoy"
    ...
    try:
        ...
        for _, group_df in df.groupby("query"):
            ...
            if result_df is not None:
                output_file = os.path.join("pipeline_results_ABAG_decoy", f"metrics_{name}.csv")
