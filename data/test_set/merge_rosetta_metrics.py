...
import pandas as pd
import os
from af_analysis.calc_rosetta_energy import batch_extract

# 1. 원본 CSV 파일 로드
input_csv = "/home/cseomoon/appl/af_analysis-0.1.4/data/test_set/ABAG_final_test_dataset_20250512.csv"
output_csv = "/home/cseomoon/appl/af_analysis-0.1.4/data/test_set/ABAG_final_test_dataset_with_rosetta_metrics_20250521.csv"
